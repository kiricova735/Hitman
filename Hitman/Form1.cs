...
namespace Hitman
{
    public partial class Hitman : Form
    {
        ...
        SoundPlayer carhit = new SoundPlayer(Properties.Resources._144113__avakas__man_hit_by_car);
        SoundPlayer doorsqueak = new SoundPlayer(Properties.Resources._346212__inspectorj__door_squeak_normal_d);
        SoundPlayer scream = new SoundPlayer(Properties.Resources._56901__syna_max__wilhelm_scream_outtake);
        SoundPlayer beartrap = new SoundPlayer(Properties.Resources._278203__thepriest909__bear_trap);
        SoundPlayer walking = new SoundPlayer(Properties.Resources._414335__mativve__walking_5);
        SoundPlayer bodydrop = new SoundPlayer(Properties.Resources._203039__jjhouse4__dropping_body_on_hard_ground);
        SoundPlayer doorkick = new SoundPlayer(Properties.Resources._198868__hitrison__door_thudwhamwhack);
        public Hitman()
        {
            InitializeComponent();
        }
            ...
            {//Start scenes
                ...
                case 11:
                    eventOutput.Text = "Out of no where, you decide this is a stupid mission. You leave the house through a window, and abandon the mission. " +
                        "Your target randomly later dies to a stroke, and you are task is dubbed complete. I guess you win." +
                    " Restart?";
                    redLabel.Text = "No";
                    blueLabel.Text = "Yes";
                    greenLabel.Text = "";
